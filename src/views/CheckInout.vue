<template>
  <div class="main">
    ...
    <div style="width: 100%; padding-top: 10px; display: flex; justify-content: center">
      ...
      <a-button :disabled="!allReturnable" class="batch" @click="batchOp(2)"
        >Batch Return</a-button
      ><a-button :disabled="!allRenewable" class="batch" @click="batchOp(3)"
        >Batch Renew</a-button
      >
      <a-popover
        placement="bottom"
